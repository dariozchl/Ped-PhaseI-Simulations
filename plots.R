...
########################################
######## This script performs the analyses of the simulations for the manuscript "On the feasibility of pediatric dose-finding trials in small samples with information from a preceding trial in adults."
######## This script relies on the simulated data generated by "simulation.R"
